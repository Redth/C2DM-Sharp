...
namespace C2dmSharp.Server
{
	internal class C2dmMessageTransportAsync
	{
		...
		internal static event Action<C2dmMessageTransportResponse> MessageResponseReceived;
		internal static event Action<C2dmMessage, Exception> UnhandledException;
